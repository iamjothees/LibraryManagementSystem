...
<?php
    ...
    if ($orderDetail->num_rows>0){
        echo '<div class="center">  <form method="POST" action="IB.php">  <table>
        ...
        while ( $displayRow1 = $orderDetail->fetch_assoc()){
            ...
            while ( $displayRow2 = $bookDetail->fetch_assoc()){
                ...
                if ($displayRow1['BookID'] == $displayRow2['ID']){
                    ...
                    "</td> <td><button value='$displayRow1[ID]' name='issueButton'>  Issue   </button></td>" . "</tr>" . "<br>";
                }
            }
        }
        echo '</table> </form>  <br>';
    ...
    echo  '<a href="../../Users/Admin.html"><button class="backButton" style="display: inline-block;">&lt&lt&lt</button> </a>';
?>